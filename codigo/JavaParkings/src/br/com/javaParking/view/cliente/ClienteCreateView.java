...
public class ClienteCreateView extends javax.swing.JFrame {
    ...
    // Métodos para acessar os campos de texto
...
// Métodos para acessar os botões
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ClienteCreateView.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ClienteCreateView().setVisible(true);
            }
        });
    }

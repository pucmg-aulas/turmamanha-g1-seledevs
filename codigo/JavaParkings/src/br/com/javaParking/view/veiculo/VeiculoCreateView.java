 ...
 * @author rafae
 */
public class VeiculoCreateView extends javax.swing.JFrame {

    /**
     * Creates new form AddVeiculoView
     */
    public VeiculoCreateView() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VeiculoCreateView.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new VeiculoCreateView().setVisible(true);
            }
        });
    }
